...
- Updated **[Atum](https://github.com/KingContaria/atum)** [1.3.1+1.17.1 -> 2.6+1.17.x]
- Updated **[FastReset](https://github.com/KingContaria/FastReset)** [1.5.1+1.17-1.18.1 -> 2.4+1.17-1.18.1]
- Updated **[StandardSettings](https://github.com/KingContaria/StandardSettings)** [1.2.4+1.17.x -> 2.3+1.17.x]
- Updated **[WorldPreview](https://github.com/KingContaria/worldpreview)** [5.0.2+1.17.1 -> 6.3.1+1.17.x]
